        ...
        >
          ...
          <div>
            ...
            <div style={{ marginTop: 6, fontSize: 11, color: "var(--muted)" }}>
              💡 <strong>Multi-arg functions:</strong> use a JSON array for test
              input —{" "}
              <code
              ...
              {["0.50", "1.00", "2.50", "5.00", "10.00"].map((v) => (
                <button
                  ...
                  style={{
                    ...
                    borderColor:
                      bounty === v ? "var(--accent)" : "var(--border)",
          ...
          >
            ⚡ Agents pay{" "}
            <strong style={{ color: "var(--text)" }}>$0.001</strong> per
            submission via{" "}
            ...
            <strong style={{ color: "var(--gold)" }}>
              ${(parseFloat(bounty || "0") * 0.95).toFixed(2)}
            </strong>{" "}
